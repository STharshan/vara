...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Just the guys you need. From a tune up to a full engine conversion. Lots of knowledge and a good standard of work for a resonable price. If you own an old VW this is the place to go",
    name: "Matt W",
  },
