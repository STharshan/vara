...
const services = [
  ...
  },
  {
    ...
    desc: `We offer expert diagnosis of all vehicle faults.​`,
    image: "/gray.avif",
    path: "/services/service",
  },
  {
    title: "Bodywork",
    desc: `We offer all levels of bodywork varying from full resprays to smaller repairs such as scuffs.`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[75%] mx-auto mt-25 h-30 object-cover"
                    onError={(e) => {
